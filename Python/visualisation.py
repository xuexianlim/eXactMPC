...
def visualise(q, qOld, qDes, t, k):
    ...
    plt.savefig("Excavator_{y}.jpg".format(y=k))

def graph(t0, t1, N, name, **kwargs):
    x = csd.linspace(t0, t1, N + 1)
    ...
    plt.savefig("Graph_{name}.jpg".format(name=name), bbox_inches='tight')